...
export const AgregarActividad = ({ id }) => {

    const { crearFormActividad } = useUsuario();
    ...
    const crearActividad = () => {
        ...
        crearFormActividad({
            id,
            producto: "producto desde AgregraActividad.js"
        });
    ...
    return (
        ...
        >
            ...
            <div className="flex gap-3">
                ...
                <button
                    className={`bg-green-400 hover:bg-green-600 px-2 rounded-full p-2 ${agreAct ? 'hidden' : 'block'} ${editarAct ? 'hidden' : ''}`}
